    ...
    return (
        ...
        <ThemeProvider theme={darkTheme}>
            <Container style={{ textAlign: "center" }}>
                <Typography
                    variant='h4'
                    style={{ margin: 18, fontFamily: "Montserrat", color: "red" }}
                >
                    Global Cryptocurrency Prices & Market Caps
                </Typography>
                <TextField
                ...
                <TableContainer>
                    {loading ? (
                        <LinearProgress style={{ backgroundColor: "#eb81e7" }}></LinearProgress>
                    ) : (
                        <>

                            <Table>
                                <TableHead style={{ backgroundColor: "#eb81e7" }}>
                                    <TableRow>
